...
if(request.getParameter("submit")!=null)
{
	...
	Class.forName("com.mysql.jdbc.Driver").newInstance(); 
		...
		pst=con.prepareStatement("insert into pms.crecord(fname,lname,cid,address,pno,iplace,date,time,crime,dcrime)values(?,?,?,?,?,?,?,?,?,?)");
                ...
                <div class="card-body">
                    <form method="post" action="" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group1">
                                    <input class="input--style-5" type="text" name="iplace">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
