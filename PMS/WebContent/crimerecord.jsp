...
if(request.getParameter("submit")!=null)
{
	...
	Class.forName("com.mysql.jdbc.Driver").newInstance(); 
		...
		pst=con.prepareStatement("insert into pms.crecord2(fname,lname,cid,address,pno,crime,dcrime)values(?,?,?,?,?,?,?)");
		pst.setString(1, fname);
		pst.setString(2, lname);
		pst.setString(3, cid);
		pst.setString(4, address);
		pst.setString(5, pno);
		pst.setString(6, crime);
		pst.setString(7,dcrime);
		pst.executeUpdate();
		System.out.println("recourd added");
		response.sendRedirect("viewrec.jsp");
  ...
  <div class="container-fluid"id="navid">
    ...
    <div class="collapse navbar-collapse" id="ulcolor">
      <ul class="nav navbar-nav"id=ulid1>
        ...
        <li><a href="viewrec.jsp" id="naid3"><i class="fa fa-users" aria-hidden="true"></i>
 View Records</a></li>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Criminal record  Form</h2>
                </div>
                <div class="card-body">
                    <form method="post" action="" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group1">
                                    <input class="input--style-5" type="text" name="cid">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group1">
                                    <input class="input--style-5" type="text" name="pno">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group1">
                                    <input class="input--style-5" type="text" name="crime">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group1">
                                    <input class="input--style-5" type="text" name="dcrime">
                                </div>
                            </div>
                        </div>
                        <div>
