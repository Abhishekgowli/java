...
<head>
	...
	<title>Liblary dashbord </title>
	<style><%@include file="/dashbordstyle.css"%></style>
...
<!--	navbar starts here-->
 ...
 About us</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="insertdetails.jsp"><i class="fa fa-user-plus" aria-hidden="true"></i>
 Add Users</a></li>
       ...
       <div class="row">
           <div class="col-sm-3 col-md-2 sidebar">
               <ul class="nav nav-sidebar">
                   ...
                   <li><a href="insertdetails.jsp"><i class="fa fa-user-plus" aria-hidden="true"></i> Insert Data</a></li>
  ...
  <div class="input-group">
	...
	<tr>
		...
		<% 
			...
			String dbpass="root";
			ResultSet rs;
			String query="select * from lib.libdata";
			   ...
			   if(squery!=null)
			   {
				     query="select * from lib.libdata where fname like '%"+squery+"%' ";
			   }
			   else{
				   query="select * from lib.libdata";
		...
		<td><%=rs.getString("aurth") %></td>
		<td><%=rs.getString("stream") %></td>
		<td><%=rs.getString("dep") %></td>
		<td><%=rs.getString("dot") %></td>
		<td><%=rs.getString("dor") %></td>
		<td><a href="updatelib.jsp?id=<%=id%>" class="btn1 btn--pill btn--orange btn-lg">Edit</a></td>
